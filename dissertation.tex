...
\ganttgroup{Enhancements to Input Features}{2}{6} \\
\ganttbar{Hand recognition with NN}{2}{3} \\
\ganttbar{Advanced Optical Flow Features}{4}{6} \\
\ganttbar{Further Rule Discovery and Optimization}{6}{8} \\
\ganttbar{Evaluation of System}{9}{9}\\
\ganttbar{Updated Dissertation Document}{10}{11} \\
